...
There's plenty of other interesting correlations to look at, however the general idea is that there's quite high correlation among key variables. Later on we will see whether this hurts the model in general or not.
